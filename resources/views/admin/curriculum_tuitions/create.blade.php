...
@section('title', 'เพิ่มข้อมูลหลักสูตรและค่าเทอม')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">เพิ่มข้อมูลหลักสูตรและค่าเทอม</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.curriculum_tuitions.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description_thai" name="description_thai" rows="3">{{ old('description_thai') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="description_english" class="form-label">คำอธิบายเกี่ยวกับหลักสูตร (ภาษาอังกฤษ)</label>
                    <textarea class="form-control" id="description_english" name="description_english" rows="3">{{ old('description_english') }}</textarea>
                </div>
                ...
                <div id="tuition-fees-container">
                    @if(old('tuition_fees'))
                        @foreach(old('tuition_fees') as $index => $fee)
                ...
                <div id="curriculum-years-container">
                    @if(old('curriculum_years'))
                        @foreach(old('curriculum_years') as $index => $year)
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="curriculum_pdf_url" name="curriculum_pdf_url" value="{{ old('curriculum_pdf_url') }}" placeholder="https://example.com/file.pdf">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="curriculum_pdf_name_thai" class="form-label">ชื่อไฟล์ PDF (ภาษาไทย)</label>
                            <input type="text" class="form-control" id="curriculum_pdf_name_thai" name="curriculum_pdf_name_thai" value="{{ old('curriculum_pdf_name_thai') }}" placeholder="ชื่อไฟล์ในภาษาไทย">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="curriculum_pdf_name_english" name="curriculum_pdf_name_english" value="{{ old('curriculum_pdf_name_english') }}" placeholder="File name in English">
                        </div>
                    </div>
                    <div class="col-md-6">
