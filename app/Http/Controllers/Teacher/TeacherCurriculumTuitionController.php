...
class TeacherCurriculumTuitionController extends Controller
{
    public function index()
    {
       $curriculumTuition = CurriculumTuition::latest()->get();
        return view('teacher.curriculum_tuitions.index', compact('curriculumTuition'));;
    }

    public function create()
    {
        return view('teacher.curriculum_tuitions.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $curriculumTuition = CurriculumTuition::create($data);

        return redirect()->route('teacher.curriculum_tuitions.index')->with('success','เพิ่มข้อมูลหลักสูตรและค่าเทอมเรียบร้อย');
    }

    public function edit(CurriculumTuition $curriculumTuition)
    {

        return view('teacher.curriculum_tuitions.edit', compact('curriculumTuition'));
    }
    ...
    public function update(Request $request, CurriculumTuition $curriculumTuition)
    {
        ...
        return redirect()->route('teacher.curriculum_tuitions.index')->with('success','แก้ไขข้อมูลหลักสูตรและค่าเทอมเรียบร้อย');
    }
    ...
    public function destroy(CurriculumTuition $curriculumTuition)
    {
        ...
        return redirect()->route('teacher.curriculum_tuitions.index')->with('success','ลบข้อมูลหลักสูตรและค่าเทอมเรียบร้อย');
    }
}
